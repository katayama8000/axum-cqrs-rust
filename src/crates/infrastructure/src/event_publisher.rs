...
impl RedisProjectionHandler {
    ...
    async fn rebuild_circle_from_events(
        &self,
        circle_id: &domain::aggregate::value_object::circle_id::CircleId,
    ) -> Result<domain::aggregate::circle::Circle> {
